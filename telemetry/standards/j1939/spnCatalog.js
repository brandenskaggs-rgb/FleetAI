const SPN_CATALOG = {
  ...
  65262: [
    ...
    { spn: 175, name: "oil_temp", start: 2, length: 2, scale: 0.03125, offset: -273, unit: "c" }
  ],
  65263: [
    { spn: 94, name: "fuel_delivery_pressure", start: 0, length: 1, scale: 4, offset: 0, unit: "kpa" },
    { spn: 98, name: "engine_oil_level", start: 1, length: 1, scale: 0.4, offset: 0, unit: "pct" },
    { spn: 100, name: "oil_pressure", start: 3, length: 1, scale: 4, offset: 0, unit: "kpa" }
  ],
  65265: [
    { spn: 84, name: "vehicle_speed", start: 1, length: 2, scale: 1 / 256, offset: 0, unit: "kph" }
  ],
  65269: [
    { spn: 108, name: "barometric_pressure", start: 0, length: 1, scale: 0.5, offset: 0, unit: "kpa" },
    { spn: 171, name: "ambient_temp", start: 3, length: 2, scale: 0.03125, offset: -273, unit: "c" }
  ],
  65266: [
  ...
  65271: [
    { spn: 168, name: "battery_voltage", start: 4, length: 2, scale: 0.05, offset: 0, unit: "v" }
  ],
  65270: [
    { spn: 173, name: "exhaust_temp", start: 0, length: 2, scale: 0.03125, offset: -273, unit: "c" }
  ],
  65253: [
    { spn: 247, name: "engine_hours", start: 0, length: 4, scale: 0.05, offset: 0, unit: "h" }
  ],
  65248: [
    { spn: 244, name: "trip_distance", start: 0, length: 4, scale: 0.125, offset: 0, unit: "km" },
    { spn: 245, name: "vehicle_distance", start: 4, length: 4, scale: 0.125, offset: 0, unit: "km" }
  ],
  65276: [
    { spn: 96, name: "fuel_level", start: 1, length: 1, scale: 0.4, offset: 0, unit: "pct" }
  ]
};
