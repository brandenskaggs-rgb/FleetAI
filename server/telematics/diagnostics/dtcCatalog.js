...
const OBD_TABLE = {
  P0010: { name: "Intake camshaft position actuator circuit (bank 1)", severity: "warning" },
  P0011: { name: "Intake camshaft timing over-advanced (bank 1)", severity: "warning" },
  P0012: { name: "Intake camshaft timing over-retarded (bank 1)", severity: "warning" },
  P0013: { name: "Exhaust camshaft position actuator circuit (bank 1)", severity: "warning" },
  P0014: { name: "Exhaust camshaft timing over-advanced (bank 1)", severity: "warning" },
  P0015: { name: "Exhaust camshaft timing over-retarded (bank 1)", severity: "warning" },
  P0016: { name: "Crankshaft/camshaft timing misalignment", severity: "critical", driveability: "stop" },
  P0017: { name: "Crankshaft/exhaust camshaft timing misalignment (bank 1)", severity: "critical", driveability: "stop" },
  P0018: { name: "Crankshaft/intake camshaft timing misalignment (bank 2)", severity: "critical", driveability: "stop" },
  P0019: { name: "Crankshaft/exhaust camshaft timing misalignment (bank 2)", severity: "critical", driveability: "stop" },
  ...
  P0340: { name: "Camshaft position sensor A circuit (bank 1)", severity: "warning", driveability: "limp" },
  P0341: { name: "Camshaft position sensor A range/performance (bank 1)", severity: "warning", driveability: "limp" },
  P0342: { name: "Camshaft position sensor A circuit low (bank 1)", severity: "warning", driveability: "limp" },
  P0343: { name: "Camshaft position sensor A circuit high (bank 1)", severity: "warning", driveability: "limp" },
  P0344: { name: "Camshaft position sensor A circuit intermittent (bank 1)", severity: "warning", driveability: "limp" },
  P0345: { name: "Camshaft position sensor A circuit (bank 2)", severity: "warning", driveability: "limp" },
  P0346: { name: "Camshaft position sensor A range/performance (bank 2)", severity: "warning", driveability: "limp" },
  P0347: { name: "Camshaft position sensor A circuit low (bank 2)", severity: "warning", driveability: "limp" },
  P0348: { name: "Camshaft position sensor A circuit high (bank 2)", severity: "warning", driveability: "limp" },
  P0349: { name: "Camshaft position sensor A circuit intermittent (bank 2)", severity: "warning", driveability: "limp" },
